...
| Taskbar height override (`screen.availHeight`) | ✅ | 🔴 | ✅ `launcher.rs` (`taskbar_height`, W44 5a6b3d3, schema v13 — mốc: sau W44 toàn bộ flag `--fingerprint-*` của README đã expose) | `README.md#L726` |
